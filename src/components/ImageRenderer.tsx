...
export default function ImageRenderer({
  ...
  useEffect(() => {
    ...
    } else if (localPattern.test(src) && typeof window !== 'undefined' && (window as any).VERCEL) {
      setProxiedSrc('https://images.unsplash.com/photo-1526318472351-c75fcf070305?w=1200&auto=format&fit=crop&q=60')
    } else {
      // 普通图片：直接使用
      setProxiedSrc(src)
    }
